...
class Print_ARSIP_Mahasiswa extends FPDF
{
    ...
    function teks2($tahun)
    {
        ...
        $this->cell(0,8,"",0,1);
        $this->Cell(5);
        $this->cell(0,8,"Perihal            : Arsip Mahasiswa Tahun ".ucfirst($tahun),0,1);
    }
    function table($data)
    {
        $this->Ln(5);
        ...
        $this->SetX($left += 10); $this->Cell(30, $h, 'NIM', 1, 0, 'C',true);
        $this->SetX($left += 30); $this->Cell(70, $h, 'Nama Mahasiswa', 1, 0, 'C',true);
        $this->SetX($left += 70); $this->Cell(45, $h, 'Jenis Kelamin', 1, 0, 'C',true);
        $this->SetX($left += 45); $this->Cell(45, $h, 'Email', 1, 0, 'C',true);
        $this->SetX($left += 45); $this->Cell(50, $h, 'Alamat', 1, 0, 'C',true);
        $this->SetX($left += 50); $this->Cell(25, $h, 'Angkatan', 1, 1, 'C',true);

        $no=1;
        foreach ($data->result() as $item) {
            $this->SetWidths(array(10,30,70,45,45,50,25));
