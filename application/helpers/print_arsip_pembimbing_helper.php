...
class Print_ARSIP_Pembimbing extends FPDF
{
    ...
    function teks2($tahun)
    {
        ...
        $this->cell(0,8,"",0,1);
        $this->Cell(5);
        $this->cell(0,8,"Perihal            : Arsip Pembimbing Tahun ".ucfirst($tahun),0,1);
    }
    function table($data)
    {
        $this->Ln(5);
        ...
        $this->SetX($left += 10); $this->Cell(45, $h, 'Nama Dosen', 1, 0, 'C',true);
        $this->SetX($left += 45); $this->Cell(45, $h, 'Nama Mahasiswa', 1, 0, 'C',true);
        $this->SetX($left += 45); $this->Cell(45, $h, 'Nama Perusahaan', 1, 0, 'C',true);
        $this->SetX($left += 45); $this->Cell(35, $h, 'ID KP', 1, 0, 'C',true);
        $this->SetX($left += 35); $this->Cell(45, $h, 'Nama Laporan', 1, 0, 'C',true);
        $this->SetX($left += 45); $this->Cell(45, $h, 'Status Laporan', 1, 1, 'C',true);
        ...
        foreach ($data->result() as $item) {
            ...
            $this->SetWidths(array(10,45,45,45,35,45,45));
