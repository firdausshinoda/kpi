...
class Print_DATA_KP extends FPDF
{
    ...
    function teks2()
    {
        ...
        $this->cell(0,8,"",0,1);
        $this->Cell(5);
        $this->cell(0,8,"Perihal            : Data Mahasiswa Kerja Praktik Tahun ".date('Y'),0,1);
    }
    function table()
    {
        ...
        $wilayah = $CI->db->select('wilayah.*')
            ...
            ->get_where("wilayah",array('kp.deleted_flage'=>1,'kp.stt_arsip'=>0,'kp.stt'=>"1"));
        ...
        foreach ($wilayah->result() as $it_wil) {
            ...
            $where_2 = array('kp.deleted_flage'=>1,'kp.stt_arsip'=>0,'kp.stt'=>"1",'kp_perusahaan.id_wilayah'=>$it_wil->id_wilayah);
