    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Arsip Dosen</li>
            </ol>
        </section>
        ...
        <section class="content connectedSortable">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-brown">
                        <div class="box-header">
                            <h3 class="box-title">Arsip Dosen</h3>
...
<script type="text/javascript">
    ...
    document.getElementById('d_arsip_dosen').setAttribute("class", "active");
    ...
    $(function () {
        var dt_table = $("#example2").DataTable({
            ...
            "paging": true,
            "ajax": {
                "url": '<?= base_url('Admin/arsip_dosen_json');?>',
                "type": "POST",
                "data": function (d) {
                    loading_page_start();
                    d.tahun = $('#tahun').val();
            ...
            "columns": [
                { "render": function ( data, type, row )
                    {
                        return '<center><input type="checkbox" name="tandai[]" value="'+row.id_dosen+'/'+row.nama_dosen+'"></center>';
                    }
                },
                ...
                { "render": function ( data, type, row )
                    {
                        return '<a href="javascript:void();" onclick="detail(\''+row.id_dosen+'\');">'+row.nama_dosen+'</a>';
                    }
                },
                {"data": "jabatan"},
                {"data": "alamat"},
    ...
    function download_arsip(type) {
        window.open("<?= base_url('Admin/arsip_dosen_cetak?type=')?>"+type+"&tahun="+$('#tahun').val(), '_blank');
    }
    function check_all() {
               ...
               setTimeout(function(){
                   $.ajax({
                       type: "POST", data: data, processData: false,
                        contentType: false, url: "<?php echo base_url('Admin/arsip_dosen_proses')?>",
                       success: function(data) {
                           if (data==1) {
                               swal("Sukses", "", "success");
                               cari();
