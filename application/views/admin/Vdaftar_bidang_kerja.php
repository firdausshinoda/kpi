...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Document <small>Daftar Bidang Kerja</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-book"></i> Document</a></li>
                <li class="active">Daftar Bidang Kerja</li>
            </ol>
        </section>
...
<script type="text/javascript">
    ...
    document.getElementById('d_bidang_kerja').setAttribute("class", "active");
    ...
    function viewdata(str,id)
    {
        ...
        $.ajax({
                type: "GET",
                data: {'page':str,'id':id},
                url: "<?php echo base_url('Admin/daftar_bidang_kerja_data'); ?>"
            }).done(function( data ) {
                loading_page_end();
                $('#viewdata').html(data);
        });
    ...
    function hapus(str,str2)
    {
        swal({
                title: "Anda Yakin?",
                text: "Anda akan menghapus bidang kerja "+str2+"!",
                type: "warning",
            ...
            function(){
                setTimeout(function(){
                    ...
                    data.append('id', str);
                    data.append('bidang_kerja', str2);
                    $.ajax({
                        type: "POST", data: data, processData: false,
                        contentType: false, url: "<?php echo base_url('Admin/input_hapus_bidang_kerja')?>",
            ...
            swal({
                ...
                function(){
                    setTimeout(function(){
                        var data = new FormData();
                        data.append('id', str);
                        data.append('bidang_kerja', $("#bidang_kerja").val());
                        $.ajax({
                            type: "POST", data: data, processData: false,
                            contentType: false, url: "<?php echo base_url('Admin/input_ubah_bidang_kerja')?>",
                            success: function(data)
                            {
                                if (data==1) {
                                    swal("Sukses", "", "success");
    ...
    {
        if ($("#bidang_kerja").val() == "") {
            swal("Oops...", "Silahkan bidang_kerja untuk wajib di isi.", "error");
        } else {
            swal({
                    title: "Anda Yakin?",
                ...
                function(){
                    setTimeout(function(){
                        ...
                        $.ajax({
                            type: "POST", data: data, processData: false,
                            contentType: false, url: "<?php echo base_url('Admin/input_tambah_bidang_kerja')?>",
                            success: function(data)
                            {
                                if (data==1) {
                                    swal("Sukses", "", "success");
