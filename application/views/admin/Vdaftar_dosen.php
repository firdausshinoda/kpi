...
<script type="text/javascript">
    function viewdata(str)
    {
        ...
        document.getElementById('d_dsn').setAttribute("class", "active");
        $.ajax(
            {
                type: "GET",
                data: {'page' : str},
                url: "<?php echo base_url('Admin/daftar_dosen_data'); ?>"
            }
        ).done(function( data )
        {
    ...
    function simpan()
    {
        if ($("#nipy").val() == "" || $("#nama").val() == "" || $("#jabatan").val() == "") {
                ...
                function(){
                    setTimeout(function(){
                        ...
                        $.ajax({
                            ...
                            processData: false,
                            contentType: false,
                            url: "<?php echo base_url('Admin/input_tambah_dosen')?>",
                            success: function(data)
                            {
                                if (data==1)
                                {
            ...
            function(){
                setTimeout(function(){
                    ...
                    $.ajax({
                        ...
                        processData: false,
                        contentType: false,
                        url: "<?php echo base_url('Admin/input_hapus_dosen')?>",
                        success: function(data)
                        {
                            if (data==1)
                            {
            ...
            function(){
                setTimeout(function(){
                    ...
                    $.ajax({
                        ...
                        processData: false,
                        contentType: false,
                        url: "<?php echo base_url('Admin/input_ubahimg_dosen')?>",
                        success: function(data)
                        {
                            if (data==1)
                            {
            ...
            function(){
                setTimeout(function(){
                    ...
                    $.ajax({
                        ...
                        processData: false,
                        contentType: false,
                        url: "<?php echo base_url('Admin/input_ubahpass_dosen')?>",
                        success: function(data)
                        {
                            if (data==1)
                            {
            ...
            function(){
                setTimeout(function(){
                    ...
                    $.ajax({
                        ...
                        processData: false,
                        contentType: false,
                        url: "<?php echo base_url('Admin/input_ubahprofil_dosen')?>",
                        success: function(data)
                        {
                            if (data==1)
                            {
    ...
    function arsipkan() {
        ...
        for (var i = 0; i < ttl_arsip; i++) {
            if (arsip[i].checked){
                data.append("id_dosen[]", arsip[i].value);
            } else {
                ttl_arsip_check++;
            }
        }
            ...
            function(){
                setTimeout(function(){
                    $.ajax({
                        ...
                        contentType: false, url: "<?php echo base_url('Admin/daftar_dosen_arsipkan')?>",
                        success: function(data)
                        {
                            if (data==1) {
                                swal("Sukses", "", "success");
