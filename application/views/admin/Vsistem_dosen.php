...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Sistem <small>Dosen Terhapus</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-archive"></i> Sistem</a></li>
                <li class="active">Dosen Terhapus</li>
            </ol>
        </section>
...
<script type="text/javascript">
    function viewdata()
    {
        ...
        document.getElementById('s_dosen').setAttribute("class", "active");
        ambil_data();
    }
    function ambil_data() {
        $.ajax(
            {
                type: "GET",
                url: "<?php echo base_url('Admin/sistem_dosen_data'); ?>"
            }
        ).done(function( data )
        {
            loading_page_end();
