                ...
                <div class="form-group">
                    <table id="example2" class="table table-bordered table-striped" style="width: 100%">
                        ...
                        <?php $no=0;foreach ($daftar->result() as $a): $no++;?>
                            <tr>
                                <td><center><input type="checkbox" name="arsip[]" value="<?= $a->id_mahasiswa."/".$a->nama_mahasiswa; ?>"></center></td>
                                <td> <?php echo $no; ?> </td>
                                <td>
                                ...
                                <td> <a href="javascript:avoid()" onclick="detail('<?php echo $a->id_mahasiswa;?>')"><?php echo $a->nama_mahasiswa; ?></a> </td>
                                ...
                                <td>
                                    <center>
                                        <button type="button" onclick="ubah('<?php echo $a->id_mahasiswa;?>')" class="btn btn-info col-md-12">Ubah</button>
                                        <button type="button" onclick="hapus('<?php echo $a->id_mahasiswa;?>','<?php echo $a->nama_mahasiswa;?>')" class="btn btn-danger col-md-12">Hapus</button>
                                    </center>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <h5><b>NIM (*)</b></h5>
                                <input class="form-control" id="nim" placeholder="NIM wajib diisi dan jangan sampai salah nomor karena akan permanen"></input>
                            </div>
                            <div class="form-group">
                                <h5><b>Nama Mahasiswa (*)</b></h5>
                                <input class="form-control" id="nama" placeholder="Nama Mahasiswa"></input>
                            </div>
                            <div class="form-group">
                                <h5><b>Agama</b></h5>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <h5><b>Tahun Angkatan</b></h5>
                            <select class="form-control" id="angkatan" >
                                <option value="">Tahun</option>
                                <?php
                                for ($i=date('Y'); $i >=date('Y')-40; $i-=1)
                                {
                                    echo "<option value='$i'>".$i."</option>";
                                }
                                ?>
        ...
        <div class="col-md-12">
            <div class="box box-brown">
                <div class="box-header with-border">
                    <h3 class="box-title">Ubah akun <?php echo $a->nama_mahasiswa; ?></h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="box box-brown">
                <div class="box-body box-profile">
                    <form>
                        ...
                        <?php if (!empty($a->foto_mahasiswa)): ?>
                            <img id="uploadPreviewsp" src="<?php echo base_url('assets/document/img/mahasiswa/'.$a->foto_mahasiswa)?>" class="profile-user-img img-responsive img-circle" alt="User profile picture">
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                        <h3 class="profile-username text-center"><?php echo $a->nama_mahasiswa; ?></h3>
                        <p class="text-muted text-center"><?php echo $a->id_mahasiswa; ?></p>
                        <input style="margin:1%;" id="img" type="file" value="Pilih" onchange="PreviewImagesp();"/>
                        <button type="button" onclick="ubahimg('<?php echo $a->id_mahasiswa;?>','<?php echo $a->nama_mahasiswa;?>','<?php echo $a->foto_mahasiswa;?>')" class="btn btn-default btn-block"> Save Image <i class="fa fa-save"></i></button>
                    </form>
                    <ul class="list-group list-group-unbordered">
                        ...
                        <li class="list-group-item">
                            <b>Nama</b> <a class="pull-right"><?php echo $a->nama_mahasiswa; ?></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="box box-brown">
                ...
                <div class="box-body">
                    ...
                    <button type="button" onclick="ubahpass('<?php echo $a->id_mahasiswa;?>','<?php echo $a->nama_mahasiswa;?>')" class="btn btn-default btn-block"> Simpan password <i class="fa fa-save"></i></button>
                </div>
            </div>
        </div>
                ...
                <div class="box box-brown">
                    ...
                    <div class="box-body">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama" placeholder="Nama" value="<?php echo $a->nama_mahasiswa; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputName" class="col-sm-2 control-label">NIM</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" disabled id="nim" placeholder="NIM" value="<?php echo $a->id_mahasiswa; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Date Training</label>
                                <div class="col-md-3">
                                    <select class="form-control" id="tgl" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" id="gol_drh" >
                                        <option value="<?php echo $a->golongan_darah;?>"><?php echo $a->golongan_darah;?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="angkatan" >
                                        <option value="<?php echo $a->angkatan;?>"><?php echo $a->angkatan;?></option>
                                        <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <h5><i class="fa fa-hourglass-2 "></i> Dirubah terakhir pada <?php echo waktu_lalu2($a->mdate); ?></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="box-footer">
                        <div class="pull-right">
                            ...
                            <button type="button" onclick="ubahprofil('<?php echo $a->id_mahasiswa;?>','<?php echo $a->nama_mahasiswa;?>')" class="btn btn-primary"> Save Change <i class="fa fa-arrow-right"></i></button>
                        </div>
                    </div>
                </div>
            </form>
