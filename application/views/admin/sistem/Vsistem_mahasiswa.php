...
<div class="col-md-12">
    <div class="box box-brown">
        <div class="box-header">
            <h3 class="box-title">Daftar Mahasiswa Terhapus</h3>
                        ...
                        <tr>
                            <td>
                                <?php if (empty($a->foto_mahasiswa)): ?>
                                    <center><input type="checkbox" name="tandai[]" value="<?= $a->id_mahasiswa."/".$a->nama_mahasiswa."/0"; ?>"></center>
                                <?php else: ?>
                                    <center><input type="checkbox" name="tandai[]" value="<?= $a->id_mahasiswa."/".$a->nama_mahasiswa."/".$a->foto_mahasiswa; ?>"></center>
                                <?php endif; ?>
                            </td>
                            <td> <?php echo $no; ?> </td>
                            <td>
                                ...
                                <?php else: ?>
                                    <img style="width:100%;"src="<?php echo base_url('assets/document/img/mahasiswa/'.$a->foto_mahasiswa);?>" class="profile-user-img img-responsive img-circle" alt="Dosen Image">
                                <?php endif; ?>
                            </td>
                            <td> <a href="javascript:avoid()" onclick="detail('<?php echo $a->id_mahasiswa?>')"><?php echo $a->nama_mahasiswa; ?></a></td>
                            <td> <?php echo $a->id_mahasiswa; ?> </td>
                            <td> <?php echo $a->alamat; ?> </td>
                            <td> <?php echo $a->email; ?> </td>
                            <td> <?php echo waktu_lalu2($a->ddate); ?> </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
            ...
            function(){
                setTimeout(function(){
                    $.ajax({
                        ...
                        contentType: false, url: "<?php echo base_url('Admin/mahasiswa_terhapus_proses')?>",
