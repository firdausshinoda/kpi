  ...
  <body class="hold-transition skin-brown layout-top-nav fixed" onload="viewdata();">
...

    {
      ...
      $.ajax(

        {
          ...
          url: "<?php echo base_url('Dosen/dashboard'); ?>"
...

    {
      ...
      $.ajax(

        {
          ...
          url: "<?php echo base_url('Dosen/dashboard_data_post'); ?>"
...

    {
      ...
      $.ajax({
          ...
          url: "<?php echo base_url('Dosen/daftar_mahasiswa_dan_laporan_kptb'); ?>",

          success: function(data)

          {

            window.location = "<?php echo base_url('Dosen/Daftar_Mahasiswa_Dan_Laporan_KP');?>"
...

    {
      ...
      location.href = "<?php echo base_url('Dosen/download_dashboard')?>"+"/"+str;
