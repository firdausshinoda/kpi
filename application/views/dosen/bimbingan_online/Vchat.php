...
<?php foreach ($message->result() as $chat): ?>
  <?php if ($chat->send_by == "dosen"): ?>
    <div class="direct-chat-msg right">
      <div class="direct-chat-info clearfix">
        <span class="direct-chat-name pull-right"><?php echo $chat->nama_dosen; ?></span>
  ...
  <?php if ($chat->send_by == "mahasiswa"): ?>
    <div class="direct-chat-msg">
      <div class="direct-chat-info clearfix">
        <span class="direct-chat-name pull-left"><?php echo $chat->nama_mahasiswa; ?></span>
...
var stt = "<?php echo $chat->stt_login_mahasiswa;?>";
var wkt = "<?php echo waktu_lalu2($chat->ldate_mahasiswa);?>";
if (stt === "1")
{
