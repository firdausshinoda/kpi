...
<div class="col-md-4">
    <div class="box box-brown">
        <div class="box-body box-profile">
            <form>
                ...
                <?php if (!empty($foto)): ?>
                    <img id="uploadPreviewsp" src="<?php echo base_url('assets/document/img/dosen/'.$foto)?>" class="profile-user-img img-responsive img-circle" alt="User profile picture">
                <?php else: ?>
                ...
                <?php endif; ?>
                <h3 class="profile-username text-center"><?php echo $nama_dosen; ?></h3>
                <p class="text-muted text-center"><?php echo $id_dosen; ?></p>
                <input style="margin:1%;" id="img" class="btn btn-default" type="file" value="Pilih" onchange="PreviewImagesp();"/>
                <button type="button" onclick="ubah_img('<?php echo $id_dosen;?>','<?php echo $foto;?>')" class="btn btn-default btn-block"> Simpan Image <i class="fa fa-save"></i></button>
            </form>
            <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                    <b>Nama</b> <a class="pull-right"><?php echo $nama_dosen; ?></a>
                </li>
            </ul>
        </div>
    </div>
    <div class="box box-brown">
        ...
        <div class="box-body">
            ...
            <button type="button" onclick="ubah_pass('<?php echo $id_dosen;?>')" class="btn btn-default btn-block"> Simpan password <i class="fa fa-save"></i></button>
        </div>
    </div>
</div>
        ...
        <div class="box box-brown">
            ...
            <div class="box-body">
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nama" placeholder="Nama" disabled value="<?php echo $nama_dosen; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputName" class="col-sm-2 control-label">NIPY</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nipy" placeholder="NIPY" disabled value="<?php echo $id_dosen; ?>">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="box-footer">
                <div class="pull-right">
                    ...
                    <button type="button" onclick="ubah_biodata('<?php echo $id_dosen; ?>')" style="display:none;" id="simpan" class="btn btn-primary"> Save Change <i class="fa fa-arrow-right"></i></button>
                </div>
            </div>
        </div>
    </form>
